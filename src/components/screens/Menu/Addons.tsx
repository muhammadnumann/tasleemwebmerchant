...
function Addons({ fields, append, control, remove, productId }: IControl) {
              ...
              <div className='bg-[#EEEEEE] py-5 flex flex-col gap-4'>
                <div className='flex items-end justify-between px-11'>
                  ...
                  <div className='flex items-end gap-4'>
                    {/* <input id="default-radio-1" type="radio" checked name={`addon.${index}`} className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" /> */}
                  ...
                  <div>
                    <Input
                      rhf={{
                        control,
                        name: `addon.${index}.description_arab`,
                        variant: 'underline',
                        rules: {
                          required: {
                            value: true,
